...
nix --experimental-features "nix-command flakes" run github:nix-community/disko -- --mode disko ./hosts/mu/core/disks/disko.nix --arg ssd '"/dev/nvme0n1"' --arg hdd '"/dev/sda"'
echo "[DONE] Disko"
...
cp -f /mnt/etc/nixos/hardware-configuration.nix ./hosts/mu/core/hardware.nix
git add .
mkdir /mnt/home/tyyago
cp -r ../nix /mnt/home/tyyago/.mu
